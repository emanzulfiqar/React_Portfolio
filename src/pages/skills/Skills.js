...
const skillsData = [
    ...
    { name: 'Prime React, Ant-Design, Material-UI', proficiency: 80, bgColor: 'linear-gradient(83deg, #456e9d, rgb(4 12 78))' },
    { name: 'Next JS', proficiency: 50, bgColor: 'linear-gradient(83deg, #456e9d, rgb(4 12 78))' },
